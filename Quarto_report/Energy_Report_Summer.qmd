...
pivot_recommendations <- clean_audit_data |>
  select(c(recommendations_ranking_furnace_boiler_tune_up:recommendations_ranking_other_3, recommendations_ranking_ductwork_air_sealing_and_insulation, recommendations_ranking_misc_air_sealing_and_insulation))
...
doors_test <- exterior_doors|>
  mutate(Value = paste0(number_of_doors_of_this_type_1 ,door_s_type_1, door_s_material_1, condition_fit_of_the_doors_of_this_type_1, total_door_area_of_this_type_1))
