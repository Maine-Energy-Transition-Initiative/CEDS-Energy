...
```{r}
double_basics_test <- double_basics |>
  #select("Gallons of Kerosene", "Cost in Dollars (Kerosene)") |>
  paste(Anual_fire = double_basics$`Gallons of Kerosene`, " Gallons,", double_basics$`Cost in Dollars (Kerosene)`, "USD")

test <- as.data.frame(double_basics_test)
