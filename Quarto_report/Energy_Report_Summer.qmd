...
```{r}
#| label: attic data for chapter 3
#| echo: false
...
all_basics <- double_other |>
  rbind(character_other, attic_basics,annual_totals )|>
...
exterior_double <- exterior |>
  select('Roof age','Number of doors of this type | 1', 'Total door area of this type | 1', 'How many windows of this type there are? | 1', 'Total windows areas of this type? | 1')|>
  pivot_longer(cols = c('Roof age','Number of doors of this type | 1', 'Total door area of this type | 1', 'How many windows of this type there are? | 1', 'Total windows areas of this type? | 1'), names_to = "Info", 
    values_to = "Values"
  )

exterior_character <- exterior |>
  select('Roof type', 'Condition of the Roof?', 'Orientation of the primary roof faces','Comment about condition of the roof', 'Existing moisture control strategies?', 'Condition of moisture control strategies?', 'Comments about existing moisture control strategies?', 'Siding type', 'Condition of the siding?', 'Comment about condition of the siding', 'Door(s) type | 1', 'Number of panes in windows of this type and material | 1 [single]', 'Number of panes in windows of this type and material | 1 [double]', 'Number of panes in windows of this type and material | 1 [triple]', 'Condition of the windows of this type? | 1', 'More about condition of the windows of this type | 1') |>
  pivot_longer(cols = c('Roof type', 'Condition of the Roof?', 'Orientation of the primary roof faces', 'Existing moisture control strategies?', 'Condition of moisture control strategies?', 'Comments about existing moisture control strategies?', 'Siding type', 'Condition of the siding?', 'Comment about condition of the siding', 'Door(s) type | 1', 'Number of panes in windows of this type and material | 1 [single]', 'Number of panes in windows of this type and material | 1 [double]', 'Number of panes in windows of this type and material | 1 [triple]', 'Condition of the windows of this type? | 1', 'More about condition of the windows of this type | 1'), names_to = "Info", 
    values_to = "Values"
  )
...
#| echo: false
roof_type_characters <- exterior |>
  select('Roof type', 'Condition of the Roof?', 'Orientation of the primary roof faces','Comment about condition of the roof')

roof_type_all <- exterior |>
  select('Roof type', 'Condition of the Roof?', 'Orientation of the primary roof faces','Comment about condition of the roof') |>
  mutate(Info = paste(`Roof type`, "in ",`Condition of the Roof?`,"condition, oriented to the ", `Orientation of the primary roof faces`, ".", `Comment about condition of the roof`))#|>
  #mutate(`Roof type` = recode(`Roof type`,  'Roof type' = 'Other annual energy usage from bills',))

roof_type_all <- roof_type_all[, -c(1:4)]
