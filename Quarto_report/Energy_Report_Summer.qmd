...
energy_test_googlesheets <- all_energy_test_googlesheets[3, ]
...
all_interior <- clean_audit_data|>
 ...
 #join information into one column for stud insulation in 3.3
  ...
  pivot_longer(cols = everything() ,
    ...
    values_to = "Values")|>
  #rename the columns as they need to be displayed
  mutate(Info = recode(Info,  general_comment_about_the_living_room = 'Living room:', general_comment_about_the_bathroom_s = 'Bathroom(s):', general_comment_about_the_kitchen = 'Kitchen:'))|>
...
Here will be the table of contents (after deleting 1.5 if not needed in Word go to references and add table of content in Docs go to the insert and on the bottom is table of context)
...
```{r}
#| label: If else chapter 1.5 heading
#| echo: false
#| eval: true
#| warning: false
...
clean_audit_data <- clean_audit_data|>
  #select(could_you_perform_combustion_safety_tests_in_worst_case_scenario_1, could_you_perform_combustion_safety_tests_2, could_you_perform_combustion_safety_tests_3, could_you_perform_combustion_safety_tests_4)
...
`r if (clean_audit_data$combustionst1 == TRUE) {"We assessed combustion appliances that burn fossil fuels such as propane, heating oil, or kerosene. These include furnaces, boilers, water heaters, and gas ovens. We visually inspected the combustion appliance(s) in your home, as well as conducted combustion safety tests. This included measuring for carbon monoxide and testing that flue gases are properly exhausting from the home."} else if (clean_audit_data$combustionst2 == TRUE) {"We assessed combustion appliances that burn fossil fuels such as propane, heating oil, or kerosene. These include furnaces, boilers, water heaters, and gas ovens. We visually inspected the combustion appliance(s) in your home, as well as conducted combustion safety tests. This included measuring for carbon monoxide and testing that flue gases are properly exhausting from the home."}  else if (clean_audit_data$combustionst3 == TRUE) {"We assessed combustion appliances that burn fossil fuels such as propane, heating oil, or kerosene. These include furnaces, boilers, water heaters, and gas ovens. We visually inspected the combustion appliance(s) in your home, as well as conducted combustion safety tests. This included measuring for carbon monoxide and testing that flue gases are properly exhausting from the home."}  else if (clean_audit_data$combustionst4 == TRUE) {"We assessed combustion appliances that burn fossil fuels such as propane, heating oil, or kerosene. These include furnaces, boilers, water heaters, and gas ovens. We visually inspected the combustion appliance(s) in your home, as well as conducted combustion safety tests. This included measuring for carbon monoxide and testing that flue gases are properly exhausting from the home."} else if (clean_audit_data$combustionst1 == FALSE) {"We assessed combustion appliances that burn fossil fuels such as propane, heating oil, or kerosene. These include furnaces, boilers, water heaters, and gas ovens. We visually inspected the combustion appliance(s) in your home, but we were unable to perform combustion safety tests. "}  else if (clean_audit_data$combustionst2 == FALSE) {"We assessed combustion appliances that burn fossil fuels such as propane, heating oil, or kerosene. These include furnaces, boilers, water heaters, and gas ovens. We visually inspected the combustion appliance(s) in your home, but we were unable to perform combustion safety tests. "}  else if (clean_audit_data$combustionst3 == FALSE) {"We assessed combustion appliances that burn fossil fuels such as propane, heating oil, or kerosene. These include furnaces, boilers, water heaters, and gas ovens. We visually inspected the combustion appliance(s) in your home, but we were unable to perform combustion safety tests. "}  else if (clean_audit_data$combustionst4 == FALSE) {"We assessed combustion appliances that burn fossil fuels such as propane, heating oil, or kerosene. These include furnaces, boilers, water heaters, and gas ovens. We visually inspected the combustion appliance(s) in your home, but we were unable to perform combustion safety tests. "} else {""}`

`r if(energy_test_googlesheets$combustion_propane == TRUE){"We also performed gas leak detection tests on your propane appliance(s)."}else{""}`  


```{r}
#| label: If else chapter 1.5 draft
#| echo: false
#| eval: false
#| warning: false


if (clean_audit_data$combustionst1 == TRUE) {"We assessed combustion appliances that burn fossil fuels such as propane, heating oil, or kerosene. These include furnaces, boilers, water heaters, and gas ovens. We visually inspected the combustion appliance(s) in your home, as well as conducted combustion safety tests. This included measuring for carbon monoxide and testing that flue gases are properly exhausting from the home."} else if (clean_audit_data$combustionst2 == TRUE) {"We assessed combustion appliances that burn fossil fuels such as propane, heating oil, or kerosene. These include furnaces, boilers, water heaters, and gas ovens. We visually inspected the combustion appliance(s) in your home, as well as conducted combustion safety tests. This included measuring for carbon monoxide and testing that flue gases are properly exhausting from the home."}  else if (clean_audit_data$combustionst3 == TRUE) {"We assessed combustion appliances that burn fossil fuels such as propane, heating oil, or kerosene. These include furnaces, boilers, water heaters, and gas ovens. We visually inspected the combustion appliance(s) in your home, as well as conducted combustion safety tests. This included measuring for carbon monoxide and testing that flue gases are properly exhausting from the home."}  else if (clean_audit_data$combustionst4 == TRUE) {"We assessed combustion appliances that burn fossil fuels such as propane, heating oil, or kerosene. These include furnaces, boilers, water heaters, and gas ovens. We visually inspected the combustion appliance(s) in your home, as well as conducted combustion safety tests. This included measuring for carbon monoxide and testing that flue gases are properly exhausting from the home."} else if (clean_audit_data$combustionst1 == FALSE) {"We assessed combustion appliances that burn fossil fuels such as propane, heating oil, or kerosene. These include furnaces, boilers, water heaters, and gas ovens. We visually inspected the combustion appliance(s) in your home, but we were unable to perform combustion safety tests. "}  else if (clean_audit_data$combustionst2 == FALSE) {"We assessed combustion appliances that burn fossil fuels such as propane, heating oil, or kerosene. These include furnaces, boilers, water heaters, and gas ovens. We visually inspected the combustion appliance(s) in your home, but we were unable to perform combustion safety tests. "}  else if (clean_audit_data$combustionst3 == FALSE) {"We assessed combustion appliances that burn fossil fuels such as propane, heating oil, or kerosene. These include furnaces, boilers, water heaters, and gas ovens. We visually inspected the combustion appliance(s) in your home, but we were unable to perform combustion safety tests. "}  else if (clean_audit_data$combustionst4 == FALSE) {"We assessed combustion appliances that burn fossil fuels such as propane, heating oil, or kerosene. These include furnaces, boilers, water heaters, and gas ovens. We visually inspected the combustion appliance(s) in your home, but we were unable to perform combustion safety tests. "} else {""}
```
