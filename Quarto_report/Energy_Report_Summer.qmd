...
# filter the spreadsheet to make smaller tables for diffrent visualizations/code chunks
#Building_Audit <- Energy_Audits |>
  #filter(Adress_Name == params$adress) # Auditor_full_name == params$Auditor_full_name
...
#| echo: false
#| results: hide
 Gas_leak_message <- if (isTRUE(Building_Audit$Gas_leak_where != 'N/A')){
...
#| echo: false
#| results: hide
Health_safety_message <- if (isTRUE(Building_Audit$`Other Health & Safety Concerns` != 'NA')){
