...
#clean_audit_data <- clean_audit_data |>
  #mutate(combustionst = str_detect(could_you_perform_combustion_safety_tests_2, pattern = "Yes"))
...
`r if(energy_test_googlesheets$combustion_fuels == TRUE){"We assessed combustion appliances that burn fossil fuels such as propane, heating oil, or kerosene. These include furnaces, boilers, water heaters, and gas ovens."}else{""}`
