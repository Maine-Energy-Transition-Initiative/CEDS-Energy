...
ggplot(Building_Audit, aes(y=1))+
  geom_bar(width=1, fill ="#F5F5DC")+ #add8e6
  #scale_fill_gradient(low="#FF8888",high="#FF0000")+ #it should be working idk why it doesn't
   geom_vline(xintercept=0.67, #move this to before previous x intercepts
...
#The vline text lables
  geom_text(aes(x=0.67, label="Your Home", y=1.3), nudge_x= -0.03, colour="#59D2FE", angle=90, size = 4, text=element_text(size=20)) + #move this to the legend
...
#The vline text values 
  geom_text(aes(x=0.67, label=0.67, y=1.55), nudge_x= -0.03,nudge_y = -1, colour="#59D2FE", angle=90, text=element_text(size=11)) + #move this to the legend
...
ggsave("SE_0_67.png", width=10, height=5)
