...
#The vline text lables
  geom_text(aes(x=0.4, label="Your Home", y=1.3), nudge_x= -0.03, colour="#59D2FE", angle=90, size = 4, text=element_text(size=20)) + #move this to the legend
...
#The vline text values 
  geom_text(aes(x=0.4, label=0.4, y=1.55), nudge_x= -0.03,nudge_y = -1, colour="#59D2FE", angle=90, text=element_text(size=11)) + #move this to the legend
...
ggsave("graph_0_40.png", width=10, height=5)
