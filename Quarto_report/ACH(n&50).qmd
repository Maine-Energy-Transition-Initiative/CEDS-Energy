...
#The vline text lables
  geom_text(aes(x=0.52, label="Your Home", y=1), nudge_x= -0.03, colour="blue", angle=90, text=element_text(size=11)) +
...
#The vline text values 
  geom_text(aes(x=0.52, label=0.52, y=1.55), nudge_x= -0.03,nudge_y = -1, colour="blue", angle=90, text=element_text(size=11)) +
  ...
  theme_void()
ggsave("Helen_0_52.png", width=10, height=5)
