...
ggplot(Building_Audit, aes(y=1))+
  geom_bar(width=1, fill ="#0000")+ #add8e6 ##F5F5DC
  #scale_fill_gradient(low="#FF8888",high="#FF0000")+ #it should be working idk why it doesn't
   geom_vline(xintercept=2.04, #move this to before previous x intercepts
...
#The vline text lables
  geom_text(aes(x=2.04, label="Your Home", y=1.3), nudge_x= -0.03, colour="#59D2FE", angle=90, size = 4, text=element_text(size=20)) + #move this to the legend
...
#The vline text values 
  geom_text(aes(x=2.04, label=2,04, y=1.55), nudge_x= -0.03,nudge_y = -1, colour="#59D2FE", angle=90, text=element_text(size=11)) + #move this to the legend
...
ggsave("GCI_2_04.png", width=10, height=5)
