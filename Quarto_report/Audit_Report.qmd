...
all_basement <- clean_audit_data|>
  ...
  #rename the columns as they need to be displayed
  mutate(Info = recode(Info,  area_of_basement_crawlspace_ground_square_feet = 'Area:', insulation_of_appliances_in_basement_crawlspace = 'Insulation of appliances:', 	
basement_crawlspace_insulation_type = 'Insulation type:'))|>
  
  #arrange the rows in correct order
  arrange(factor(Info, levels = c('Area:','Inuslation type:', 'Insulation condition:')))
