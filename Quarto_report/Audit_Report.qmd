...
all_interior <- clean_audit_data |>
  ...
  mutate(`Walls:` = ifelse(
    wall_continuous_insulation_type == "NONE",
    paste0(
      stock_framing, 
    ...
    paste0(
      ...
      " insulation. This insulation is ", thickness_of_the_wall_stud_insulation, 
      " inches thick and in ", quality_of_wall_stud_insulations_installation_assess_worst_part_of_installation, 
      " condition. This insulation has an R-value of R-CALCULATE. A material’s R-value tells us how good it is at stopping heat flow, the bigger the number, the better. The exterior walls also have a layer of continuous insulation. This is made up of ",
      wall_continuous_insulation_type,
      " that is ",
      thickness_of_the_wall_continuous_insulation,
      " inches thick and in ",
  ...
  mutate(`Bathroom(s):` = ifelse(
    is.na(bathroom_fan_flow_box_readings),
