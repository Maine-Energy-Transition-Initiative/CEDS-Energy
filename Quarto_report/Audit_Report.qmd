...
mutate(
  Info = recode(
    ...
    net_wall_area_square_feet = 'Net Wall Area:',
    ambient_carbon_monoxide_reading = 'Ambient Carbon Monoxide reading:',
    foundation_type = 'Foundation Type:',
    homeowners_concerns = 'Homeowner Concerns:',
    homeowners_comment_about_existing_insulation_air_sealing_when_was_it_done = 'Homeowner Comments:',
    any_additions_recent_renovations_construction = 'Recent Construction:'
  ),
  ...
  Values = case_when(
    ...
    Info == 'Net Wall Area:' ~ paste0(comma(as.numeric(Values), accuracy = 1), " ft²"),
...
# join information into one column for breaker panel in 3.7
  ...
  mutate(`Air Conditioning:` = paste0(
    "The house is air conditioned using ",
    is_a_c_used_in_the_building,
    ". These are used ",
    how_frequently_is_a_c_used,
    ".")) |>
...
cat(paste0(
  "To test how leaky things like outlets and ductboots are, we measure the pressure difference between them and the house using a pressure pan. We measured ",
  pressure_pan,
  ". By measuring the pressure difference between different rooms, we can test how leaky individual rooms are. Any room that has a pressure difference over 5 pascals has significant air leakage occuring in it. We measured ",
  zonal_pressure))
...
b_ACHnat <- clean_audit_data$ac_hn_basement
