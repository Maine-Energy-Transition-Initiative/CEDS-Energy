...
row_number <- 63 #enter row number from spreadsheet
...
mutate(
  ...
  `Air Conditioning:` = paste0(
    ifelse(is_a_c_used_in_the_building == "None",
           paste0(""),
           paste0("The house is air conditioned using ", is_a_c_used_in_the_building, ". ",
    (ifelse(is.na(how_frequently_is_a_c_used),
            paste0(""),
            paste0("These are used ", how_frequently_is_a_c_used, ".")))))),
...
ggplot(ACHnatural_ggplot, aes(y = 1)) +
  ...
  ggtitle("Your House Compared to Standards") +
...
zonal_pressure_text <- if (!is.na(zonal_pressure)) {
  paste0("By measuring the pressure difference between different rooms, we can test how leaky individual rooms are. Any room that has a pressure difference over 5 pascals has significant air leakage occurring in it. We measured ", zonal_pressure, ".")
} else {
  ""
}
...
auto_furnace_boiler_tune_up$Description,
...
auto_window_dressers$Description,
...
auto_whole_house_surge_protection$Description,
...
auto_induction_stove$Description,
...
auto_vapor_barrier$Description,
...
auto_blow_in_cellulose$Description,
...
auto_continuous_exterior_insulation$Description,
...
auto_electrical_panel_upgrade$Description,
...
auto_air_source_heat_pump$Description,
...
auto_ev_and_charger$Description,
...
auto_pipe_insulation$Description,
...
auto_diy_air_sealing$Description,
...
auto_duct_air_sealing$Description,
...
auto_misc_air_sealing_insulation$Description,
...
auto_replace_windows$Description,
...
auto_replace_doors$Description,
