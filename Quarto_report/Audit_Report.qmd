...
energy_test_googlesheets <- all_energy_test_googlesheets[28, ] 
...
all_interior <- clean_audit_data |>
  ...
  mutate(`Kitchen:` = ifelse(
    ...
    paste0(
      ...
      " hours. We thus estimate that it is costing you around $CALCULATE a month to run. This is **comparable to / more expensive than** newer, efficient models. The ", 
      which_appliance_did_you_measure_2, " used ", k_wh_reading_2, " kWh in ", 
      time_passed_since_installation_of_kilowatt_meter_2, 
    ...
    paste0(
      ...
      which_appliance_did_you_measure_2, " used ", k_wh_reading_2, " kWh in ", 
      time_passed_since_installation_of_kilowatt_meter_2, 
      " hours.  We thus estimate that it is costing you around $CALCULATE a month to run. This is **comparable to / more expensive than** newer, efficient models. We also measured the flow speed of your kitchen exhaust fans. Kitchen exhaust fans should have a flow of at least 100 cubic feet per minute (CFM). Your kitchen exhaust fan had a flow speed of ", 
      kitchen_fan_flow_box_readings, ". ", general_comment_about_the_kitchen
    )
  )) |>

  select(`Walls:`, `Kitchen:`, general_comment_about_the_living_room, general_comment_about_the_bathroom_s) |>
  ...
  arrange(factor(Info, levels = c('Walls:', 'Living room:', 'Bathroom(s):', 'Kitchen:')))
