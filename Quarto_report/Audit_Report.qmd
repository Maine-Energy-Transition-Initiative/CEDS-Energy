...
# New rows to add
new_rows <- tibble(
  Info = c("R-value", "Attic Hatch", "Exhaust Ducts"),
  Values = NA_character_
)

# Combine, relabel, and reorder
all_attic <- bind_rows(attic_double, attic_character, new_rows) |>
  mutate(
    Info = recode(
      Info,
      "Quality of attic insulation's installation? Assess worst part of installation." = "Insulation condition:"
    )
  ) |>
  mutate(
    Info = factor(
