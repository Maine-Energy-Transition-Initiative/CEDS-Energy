...
table_3_4 <- table_3_4 |>
  ...
  mutate(
    # Add unit and note to leakage area
    Values = case_when(
...
table_3_4$Description <- c(
  ...
  "Accounting for the volume of the home, this means that the house exchanges –% of its air every hour. Over one day, the house goes through – complete air changes."
)
