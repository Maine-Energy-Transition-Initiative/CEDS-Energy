...
flextable_table <- flextable(ranked_clean_recommendations) |>
...
table_3_4 <- clean_audit_data |>
  select(`cfm50`, `volume_of_conditioned_space_cubic_feet`) |>
...
# Pivot longer
table_3_4 <- table_3_4 |>
  select(CFM50, ACH50, EquivalentLeakageArea, ACHnatural) |>
