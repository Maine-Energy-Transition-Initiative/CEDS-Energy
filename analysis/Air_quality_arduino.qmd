...
AQ01_PM10_Concentration = things_properties_timeseries(thing_id = AQ01, property_id = conc10p0_1, desc = FALSE) %>% 
  rename("PM10 Concentration" = "value")

AQ01_PM2.5_Concentration = things_properties_timeseries(thing_id = AQ01, property_id = conc2p5_1, desc = FALSE) %>% 
