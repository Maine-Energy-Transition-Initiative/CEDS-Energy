...
AQ01_Temperature = things_properties_timeseries(thing_id = "1c7d23e8-526c-435f-9514-43100c634a3d",
                                                property_id = "a7aa4f36-e201-49ad-9aa7-5e89d861e04d",
                                                desc = FALSE) %>% rename("Temperature" = "value")

AQ01_Humidity = things_properties_timeseries(thing_id = AQ01,
                                                property_id = Humidity1,
                                                desc = FALSE) %>% rename("Humidity" = "value")

AQ01_noxIndex = things_properties_timeseries(thing_id = AQ01,
                                                property_id = noxInd1,
                                                desc = FALSE) %>% rename("nox_Index" = "value")

AQ01_vocIndex = things_properties_timeseries(thing_id = AQ01,
                                                property_id = vocInd1,
                                                desc = FALSE) %>% rename("voc_Index" = "value")
